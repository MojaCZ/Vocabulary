...
class Vocabulary {
  ...
  getFiles(){
    this.availableFiles = []
    this.nFiles = 0
    var XML = getXML("vocabularyFiles")
    while(1){
    ...
    console.log("AHOJ");
    console.table(this.availableFiles)
  }
